                                ...
                                <div class="item">
                                    ...
                                    <div class="item-details">
                                        ...
                                        <div class="misc">
                                            ...
                                            <span class="remove">
                                                <a class="hyperlink" href="<?php echo e(route('shop.checkout.cart.remove', $item->id)); ?>" onclick="removeLink('Do you really want to do this?')"><?php echo e(__('shop::app.checkout.cart.remove-link')); ?></a></span>
                        ...
                        <div class="misc-controls">
                            ...
                            <div>
                                ...
                                <?php if(! cart()->hasError()): ?>
                                    <a href="<?php echo e(route('shop.checkout.onepage.index')); ?>" class="btn btn-md btn-primary">
        ...
        <?php else: ?>
            ...
            <div class="cart-content">
                ...
                <p style="display: inline-block;">
                    <a style="display: inline-block;" href="<?php echo e(route('shop.home.index')); ?>" class="btn btn-md btn-primary"><?php echo e(__('shop::app.checkout.cart.continue-shopping')); ?></a>
                </p>
            </div>
