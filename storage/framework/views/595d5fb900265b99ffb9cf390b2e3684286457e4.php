    ...
    <script type="text/x-template" id="country-state-template">
        <div>
            <div class="control-group" :class="[errors.has('country') ? 'has-error' : '']">
                ...
                <select type="text" v-validate="'required'" class="control" id="country" name="country" v-model="country" data-vv-as="&quot;<?php echo e(__('shop::app.customer.account.address.create.country')); ?>&quot;">
                    <option value=""></option>
            ...
            <div class="control-group" :class="[errors.has('state') ? 'has-error' : '']">
                ...
                <input type="text" v-validate="'required'" class="control" id="state" name="state" v-model="state" v-if="!haveStates()" data-vv-as="&quot;<?php echo e(__('shop::app.customer.account.address.create.state')); ?>&quot;"/>
                <select v-validate="'required'" class="control" id="state" name="state" v-model="state" v-if="haveStates()" data-vv-as="&quot;<?php echo e(__('shop::app.customer.account.address.create.state')); ?>&quot;">
