...
<button type="submit" data-href="<?php echo e(route('shop.product.buynow', $product->id)); ?>" class="btn btn-md btn-primary buynow" <?php echo e($product->type != 'configurable' && !$product->haveSufficientQuantity(1) ? 'disabled' : ''); ?>>
