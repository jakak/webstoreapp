    ...
    <div class="content">
        <div class="page-header">
            <div class="page-title">
                <h1>
                    <a href="<?php echo e(route('admin.domains.show')); ?>">
                        <i class="icon angle-left-icon back-link"></i>
                    </a>
                    <?php echo e(__('admin::app.settings.domains.connect-domain')); ?></h1>
            </div>
        </div>
            ...
            <form action="#">
                ...
                <div class="control-group">
                    ...
                    <label class="sub-title" for="cname">
                        <?php echo e(__('admin::app.settings.domains.add-cname-text')); ?>
                ...
                <div class="control-group">
                    ...
                    <div class="sub-title" style="color: #8B8B8B">
                        <?php echo e(__('admin::app.settings.domains.add-domain-text')); ?>
                ...
                <div class="form-bottom">
                    <button type="submit" class="btn btn-md btn-primary">
                        <?php echo e(__('admin::app.settings.domains.verify-domain')); ?>
