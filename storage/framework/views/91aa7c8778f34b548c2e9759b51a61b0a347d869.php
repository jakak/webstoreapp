        ...
        <?php else: ?>
            <?php if($product->type == "configurable"): ?>
                <div class="cart-wish-wrap">
                    <a href="<?php echo e(route('cart.add.configurable', $product->url_key)); ?>" class="btn btn-md btn-primary addtocart">
            ...
            <?php else: ?>
                <div class="cart-wish-wrap">
                    <form action="<?php echo e(route('cart.add', $product->id)); ?>" method="POST">
                        ...
                        <button class="btn btn-md btn-primary addtocart" <?php echo e($product->haveSufficientQuantity(1) ? '' : 'disabled'); ?>><?php echo e(__('shop::app.products.add-to-cart')); ?></button>
                    </form>
