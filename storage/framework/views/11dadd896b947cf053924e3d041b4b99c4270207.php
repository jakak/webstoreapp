<div class="order-summary">
    ...
    <?php elseif($cart->shipping_method && $cart->shipping_method !== 'free_free'): ?>
        <div class="item-detail">
            <label><?php echo e(__('shop::app.checkout.total.delivery-charges')); ?></label>
            <label class="right"><?php echo e(core()->currency(\App\Location::find($cart->shipping_method)->rate)); ?></label>
        </div>
    <?php endif; ?>
