...
<?php $__env->startPush('scripts'); ?>
            ...
            <div class="col-main">
                ...
                <ul class="checkout-steps">
                    ...
                    <li :class="[currentStep == 2 || completedStep > 1 ? 'active' : '', completedStep > 1 ? 'completed' : '']" @click="navigateToStep(2)">
                        ...
                        <span><?php echo e(__('shop::app.checkout.onepage.delivery')); ?></span>
                    </li>
                ...
                <div class="step-content payment" v-show="currentStep == 3">
                    ...
                    <div class="button-group">
                        ...
                        <paystack-component
                            ...
                            :amount="newTotal * 100"
                            :publicKey="'<?php echo e(core()->getConfigData('payment.paystack_payments.index.public_key')); ?>'"
                            :referenceCode="`${address.billing.first_name.replace(/\s/g, '')}-${address.billing.last_name.replace(/\s/g, '')}-`+ '<?php echo e($cart->id . '-' . $cart->grand_total); ?>'"
    ...
    <script>
        ...
        var locations = <?php echo json_encode($location, 15, 512) ?>;
        var base_price = Number(<?php echo e($cart->base_sub_total); ?>);
        var newTotal = 0;
                ...
                shippingMethodSelected (shippingMethod) {
                    ...
                    if (!currLocation) {
                        currLocation = {
                            ...
                            rate: 0.00,
                            description: `<?php echo core()->getConfigData('sales.carriers.free.description'); ?>`
                        }
                    }
