        ...
        <div class="page-header">
            ...
            <div class="page-action">
                <?php if($order->canCancel()): ?>
                    <a href="<?php echo e(route('admin.sales.orders.cancel', $order->id)); ?>" class="btn btn-md btn-primary" v-alert:message="'<?php echo e(__('admin::app.sales.orders.cancel-confirm-msg')); ?>'">
                ...
                <?php if($order->canInvoice()): ?>
                    <a href="<?php echo e(route('admin.sales.invoices.create', $order->id)); ?>" class="btn btn-md btn-primary">
                ...
                <?php if($order->canShip()): ?>
                    <a href="<?php echo e(route('admin.sales.shipments.create', $order->id)); ?>" class="btn btn-md btn-primary">
                                    ...
                                    <div class="section-content">
                                        ...
                                        <?php if(! is_null($order->customer)): ?>
                                            <div class="row">
                                                ...
                                                <span class="value">
                                                    <?php echo e($order->customer->customerGroup['name']); ?>
