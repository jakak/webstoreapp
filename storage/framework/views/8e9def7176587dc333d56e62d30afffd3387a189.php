...
<div class="auth-content">
    ...
    <div class="sign-up-text">
        <?php echo e(__('shop::app.customer.signup-text.account_exists')); ?> - <a class="hyperlink" href="<?php echo e(route('customer.session.index')); ?>"><?php echo e(__('shop::app.customer.signup-text.title')); ?></a>
    </div>
