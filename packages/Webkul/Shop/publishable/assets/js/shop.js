...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_paystack__ = __webpack_require__(37);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_payment_component__ = __webpack_require__(38);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_payment_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__components_payment_component__);
...
Vue.component("category-nav", __webpack_require__(41));
Vue.component("category-item", __webpack_require__(44));
Vue.component("image-slider", __webpack_require__(47));
Vue.component("vue-slider", __webpack_require__(55));
Vue.component("custom-footer", __webpack_require__(56));
Vue.component('paystack', __WEBPACK_IMPORTED_MODULE_0_vue_paystack___default.a);
Vue.component('paystack-component', __WEBPACK_IMPORTED_MODULE_1__components_payment_component___default.a);
...
Component.options.__file = "src/Resources/assets/js/components/payment-component.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-4b8e9e5a", Component.options)
  } else {
    hotAPI.reload("data-v-4b8e9e5a", Component.options)
  }
  ...
  return _c(
    "paystack",
    {
      attrs: {
        amount: _vm.amount,
        email: _vm.email,
        paystackkey: _vm.publicKey,
        reference: _vm.referenceCode,
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-4b8e9e5a", module.exports)
  }
}
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    watch: {
        shouldAutoScroll: function shouldAutoScroll() {
    ...
    methods: {
        ...
        setProps: function setProps() {
            ...
            if (this.images.length == 0) {
                this.images.push = "/themes/default/assets/images/default_slider/Zbleq21bzaBfYG02iWpu3MyX2fUY0Hg9FJNWC9at.jpeg";
            } else {
                this.images_loaded = true;
            }
        },
        autoScrollSlider: function autoScrollSlider() {
            var _this = this;

            this.autoScroll = setInterval(function () {
                _this.changeIndexLeft();
            }, 6000);
        },
          ...
          "div",
          {
            ...
            on: {
              mouseover: function($event) {
                _vm.shouldAutoScroll = false
              },
              mouseleave: function($event) {
                _vm.shouldAutoScroll = true
              }
            }
          },
          [
...
Component.options.__file = "src/Resources/assets/js/components/customFooter.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-084decb8", Component.options)
  } else {
    hotAPI.reload("data-v-084decb8", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var render = function() {
  ...
  return _c("p", [
    _vm._v(
      "\n    © " + _vm._s(_vm.getDate()) + " " + _vm._s(_vm.credit) + " | "
    ),
    _c(
      "a",
      {
        staticClass: "hyperlink",
        attrs: { href: "https://haqqman.com/webmaster", target: "_blank" }
      },
      [_vm._v("Webmaster")]
    )
  ])
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-084decb8", module.exports)
  }
}
