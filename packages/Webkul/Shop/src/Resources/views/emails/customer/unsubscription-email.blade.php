...
<div class="card text-left">
    <div class="card-body">
        <h3>Hello,</h3>
        <p>
            We have received your reques to unsubscribe from our newsletters and we will honor it.
        </p>
        <p>
        ...
        <hr>
        <p>
            Please contact support if you did not initiate this request.
            <a style="color: #CFE498" href="#">Contact support</a>
        </p>
