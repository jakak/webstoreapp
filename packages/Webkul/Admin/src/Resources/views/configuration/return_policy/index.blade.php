...
<form method="POST" action="{{ route('admin.configuration.footer.content.create') }}" id="createNewPage">
    ...
    <div class="page-content">
        <div class="form-container">
            ...
            {{--   Hidden Fields here --}}
            <input type="hidden" class="control" id="static_url" name="name" value="{{ "return-policy" }}" data-vv-as="state">
            ...
            <div class="control-group">
                ...
                <textarea class="control" id="page_content" name="page_content">
                     @foreach(Webkul\Core\Models\FooterContent::all() as $return)
                        {{ $return->name == "return-policy" ? $return->page_content : '' }}
                    @endforeach
                </textarea>
            </div>
            ...
            {{--   Hidden Fields here --}}
            <div class="control-group text" :class="">
                <input id="meta_title" type="hidden"  class="modify_title control" value="Return Policy" name="meta_title">
                <input id="dashboard_title" type="hidden" value="{{ core()->getCurrentChannel()->business_name ?? 'My Webstore Space' }}">
            </div>

            <div class="control-group text" :class="">
                <input name="meta_keywords" type="hidden" value="webstores, store, shop, policy, return" class="control">
            </div>
            <div class="control-group text" :class="">
